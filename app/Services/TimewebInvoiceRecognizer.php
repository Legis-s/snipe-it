...
- Для товара в упаковке (например, «3 шт.», «50 шт. в упак.») сохрани это обозначение в name.
- quantity — количество упаковок или комплектов из колонки количества счёта, без пересчёта во внутренние штуки.
- unit_price — цена одной упаковки или комплекта с НДС. Программа сама пересчитает упаковку в поштучный складской учёт.
