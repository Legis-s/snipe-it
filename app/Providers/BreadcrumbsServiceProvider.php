...
class BreadcrumbsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         * Map Breadcrumbs
         */
        Breadcrumbs::for('map', fn (Trail $trail) => $trail->parent('home', route('home'))
         ...
         */
        Breadcrumbs::for('inventories.index', fn (Trail $trail) => $trail->parent('home', route('home'))
            ->push(trans('general.inventories'), route('inventories.index'))
        );

        Breadcrumbs::for('inventories.show', fn (Trail $trail, Inventory $inventory) => $trail->parent('inventories.index', route('inventories.index'))
         ...
         */
        Breadcrumbs::for('purchases.index', fn (Trail $trail) => $trail->parent('home', route('home'))
            ->push(trans('general.purchases'), route('purchases.index'))
        );

        Breadcrumbs::for('purchases.show', fn (Trail $trail, Purchase $purchase) => $trail->parent('purchases.index', route('purchases.index'))
            ->push($purchase->invoice_number, route('purchases.show', $purchase))
        );

        Breadcrumbs::for('purchases.create', fn (Trail $trail) => $trail->parent('purchases.index', route('purchases.index'))
            ->push(trans('general.create'), route('purchases.create'))
        );

        Breadcrumbs::for('clone/purchases', fn (Trail $trail) => $trail->parent('purchases.index', route('purchases.index'))
         ...
         * Devices Breadcrumbs
         */
        Breadcrumbs::for('devices.index', fn (Trail $trail) => $trail->parent('home', route('home'))
            ->push(trans('general.devices'), route('devices.index'))
        );

        Breadcrumbs::for('devices.show', fn (Trail $trail, Device $device) => $trail->parent('devices.index', route('devices.index'))
            ->push($device->imei ?: (string) $device->number, route('devices.show', $device))
        );

        /**
         * Inventory Status Labels Breadcrumbs
         */
        Breadcrumbs::for('inventorystatuslabels.index', fn (Trail $trail) => $trail->parent('home', route('home'))
            ->push(trans('admin/inventorystatuslabels/table.title'), route('inventorystatuslabels.index'))
        );

        Breadcrumbs::for('inventorystatuslabels.create', fn (Trail $trail) => $trail->parent('inventorystatuslabels.index', route('inventorystatuslabels.index'))
            ->push(trans('general.create'), route('inventorystatuslabels.create'))
        );

        Breadcrumbs::for('inventorystatuslabels.show', fn (Trail $trail, InventoryStatuslabel $inventorystatuslabel) => $trail->parent('inventorystatuslabels.index', route('inventorystatuslabels.index'))
            ->push($inventorystatuslabel->name, route('inventorystatuslabels.show', $inventorystatuslabel))
        );

        Breadcrumbs::for('inventorystatuslabels.edit', fn (Trail $trail, InventoryStatuslabel $inventorystatuslabel) => $trail->parent('inventorystatuslabels.index', route('inventorystatuslabels.index'))
         ...
         * Deals Breadcrumbs
         */
        Breadcrumbs::for('deals.index', fn (Trail $trail) => $trail->parent('home', route('home'))
            ->push(trans('general.deals'), route('deals.index'))
        );

        Breadcrumbs::for('deals.show', fn (Trail $trail, Deal $deal) => $trail->parent('deals.index', route('deals.index'))
