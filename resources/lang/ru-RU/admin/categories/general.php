...
return [
    ...
    'required_acceptance_component' => 'Если целевой актив назначен пользователю, ему будет отправлено письмо со ссылкой для подтверждения получения компонента.',
    'required_eula_component' => 'Если целевой актив назначен пользователю, ему будет отправлена копия лицензионного соглашения.',
    ...
    'import_checkin_email' => 'Отправить письмо о возврате',
    'import_eula_text' => 'Текст лицензионного соглашения',
