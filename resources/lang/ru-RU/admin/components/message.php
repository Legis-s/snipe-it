...
return array(
    ...
    'delete' => array(
     ...
     'checkout' => array(
        'error'   		=> 'Не удалось выдать компонент, пожалуйста попробуйте еще раз',
    ...
    'checkin' => array(
        'error'   		=> 'Не удалось вернуть компонент, пожалуйста попробуйте еще раз',
        'success' 		=> 'Компонент успешно возвращен.',
