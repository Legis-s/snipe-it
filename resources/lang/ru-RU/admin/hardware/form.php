...
return [
    ...
    'redirect_to_bulk_checkout' => 'Вернуться к массовой выдаче',
    'select_statustype' => 'Выберите тип статуса',
    'serial' => 'Серийный номер',
    'serial_required' => 'Для актива :number требуется серийный номер',
    ...
    'asset_not_deployable_checkin' => '{1} Этот статус не допускает выдачу актива. Выбор статуса приведёт к возврату актива.|[2,*] Этот статус не допускает выдачу активов. Выбор статуса не приведёт к изменениям.',
    ...
    'calc_eol' => 'При очистке даты окончания срока эксплуатации рассчитать её автоматически по дате покупки и установленному сроку эксплуатации.',
