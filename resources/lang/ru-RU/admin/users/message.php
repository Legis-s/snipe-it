...
return [
    ...
    'accept_signature_write_failed' => 'Не удалось сохранить подпись в хранилище. Подтверждение получения не записано. Обратитесь к администратору.',
    'accept_pdf_write_failed' => 'Не удалось сохранить PDF подтверждения в хранилище. Подтверждение получения не записано. Обратитесь к администратору.',
    ...
    'nothing_currently_assigned' => 'Сейчас ничего не назначено.',
    'user_password_required' => 'Поле "Пароль" является обязательным.',
    'insufficient_permissions' => 'Недостаточно прав.',
    'auth_fields_denied' => 'У вас нет права изменять учётные данные или статус активации этого пользователя. Не обновлены поля: :fields',
    ...
    'error' => [
        ...
        'company_not_permitted' => 'Одна или несколько выбранных компаний находятся за пределами доступной вам области.',
    ],
