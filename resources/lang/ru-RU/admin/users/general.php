...
return [
    ...
    'activated_password_required_help' => 'При активации нового пользователя необходимо задать пароль для входа.',
    ...
    'impersonate_confirm_title' => 'Подтверждение входа от имени пользователя',
    'impersonate_confirm_body' => 'Вы собираетесь войти как :name. Все действия будут записаны от имени этого пользователя. Продолжить?',
    'impersonate_note_label' => 'Причина',
    'impersonate_note_placeholder' => 'Например: проверка обращения №12345',
    'impersonate_note_required' => 'Укажите причину входа от имени другого пользователя.',
];
