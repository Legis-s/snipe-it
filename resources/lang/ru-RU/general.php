...
return [
    ...
    'purchase_cost_format_help' => 'Используйте формат чисел, настроенный в системе (например, :format)',
    'purchase_cost_invalid' => 'Некорректный формат числа. Разрешены только цифры, точки и запятые.',
    ...
    'setup_create_admin' => 'Создание администратора',
    'setup_next' => 'Далее',
