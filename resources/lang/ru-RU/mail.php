...
return [
    ...
    'Asset_Checkin_Notification' => 'Актив возвращён: :tag',
    'Asset_Checkout_Notification' => 'Актив выдан: :tag',
    ...
    'new_item_checked_location' => 'В местоположение :location выдан :count новый предмет, подробности ниже.|В местоположение :location выдано :count новых предмета, подробности ниже.|В местоположение :location выдано :count новых предметов, подробности ниже.',
    ...
    'type' => 'Тип',
    'upcoming-audits' => 'В ближайшие :threshold дней нужно проверить :count актив.|В ближайшие :threshold дней нужно проверить :count актива.|В ближайшие :threshold дней нужно проверить :count активов.',
    'upcoming-audits_click' => 'Письмо может содержать неполный список из-за ограничения размера. Нажмите кнопку ниже, чтобы увидеть все активы, требующие проверки.',
    'user' => 'Пользователь',
    'username' => 'Имя пользователя',
    'unaccepted_asset_reminder' => 'Напоминание: у вас есть предметы с неподтверждённым получением',
