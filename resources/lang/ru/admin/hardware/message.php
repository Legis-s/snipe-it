...
return array(
    ...
    'sell' => array(
        'error'   		=> 'Активы не были проданы, пожалуйста попробуйте снова',
        'success_user' 		=> 'Активы успешно выданы на продажу.',
        'success_contract' 		=> 'Активы успешно проданы.',
        'user_does_not_exist' => 'Этот пользователь является недопустимым. Пожалуйста, попробуйте еще раз.',
        'not_available' => 'Данный актив недоступен к продаже!',
        'no_assets_selected' => 'Вы должны выбрать хотя бы один актив из списка',
        'no_type_selected' => 'Не выбрана привязка продажи активов!',
        'no_date_selected' => 'Выберите дату продажи.',
        'no_user_selected' => 'Не выбран ответственный пользователь.',
        'no_contract_selected' => 'Не выбран договор.',
    ),
