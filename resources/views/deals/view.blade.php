        ...
        <div class="col-md-3">
            @if (($deal->bitrix_id))
                <div class="col-md-12" style="padding-bottom: 20px;">
                    <a href="https://bitrix.legis-s.ru/crm/deal/details/{{ $deal->bitrix_id}}/" style="width: 100%;" class="btn btn-sm btn-info pull-left">{{ trans('general.bitrix_open') }} </a>
                </div>
            @endif
...
{{--                @if (($deal->assets_no_docs && count($deal->assets_no_docs) >0) or ($deal->consumable_no_docs_count && count($deal->consumable_no_docs_count>0)))--}}
