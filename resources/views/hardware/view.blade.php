        ...
        @if ($asset->deleted_at!='')
            <div class="col-md-12">
                <div class="alert alert-danger">
                    ...
                    You must <a href="{{ route('restore/hardware', $asset->id) }}">restore it</a> before you can assign
                    it to someone.
                </div>
            </div>
        @endif
                            ...
                            <div class="col-md-4">
                                ...
                                @if ($asset->image)
                                    <div class="col-md-12 text-center" style="padding-bottom: 15px;">
                                        <a href="{{ url('/') }}/uploads/assets/{{ $asset->image }}"
                                           data-toggle="lightbox">
                                            <img src="{{ url('/') }}/uploads/assets/{{{ $asset->image }}}"
                                ...
                                @elseif (($asset->model) && ($asset->model->image!=''))
                                    <div class="col-md-12 text-center" style="padding-bottom: 15px;">
                                        <a href="{{ url('/') }}/uploads/models/{{ $asset->model->image }}"
                                           data-toggle="lightbox">
                                            <img src="{{ url('/') }}/uploads/models/{{ $asset->model->image }}"
                                                 class="assetimg img-responsive"
                                                 alt="{{ $asset->getDisplayNameAttribute() }}">
                                        </a>
                                    </div>
                                ...
                                @if ($asset->licenses->count() > 0)
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-1"><span class="line"></span>{{ trans('table.actions') }}
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                ...
                                @can('update', \App\Models\Asset::class)
                                    <div id="maintenance-toolbar">
                                        <a href="{{ route('maintenances.create', ['asset_id' => $asset->id]) }}"
                                           class="btn btn-primary">Add Maintenance</a>
                                    </div>
                                @endcan
...
"ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                                    ...
                                    <thead>
                                    <tr>
                                        <th data-field="icon" data-visible="true" style="width: 40px;" class="hidden-xs"
                                            data-formatter="iconFormatter"><span class="sr-only">Icon</span></th>
                                        <th class="col-sm-2" data-visible="true" data-field="created_at"
                                        ...
                                        <th class="col-sm-1" data-visible="true" data-field="action_type"
                                            data-formatter="actionTypeFormatter">{{ trans('general.action') }}</th>
...
"ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                                        ...
                                        <thead>
                                        <tr>
                                            <th data-visible="true" data-field="icon"><span class="sr-only">Icon</span>
                                            </th>
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="notes">{{ trans('general.notes') }}</th>
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="image">{{ trans('general.image') }}</th>
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="filename">{{ trans('general.file_name') }}</th>
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="download">{{ trans('general.download') }}</th>
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="created_at">{{ trans('general.created_at') }}</th>
                                        ...
                                        @foreach ($asset->uploads as $file)
                                            <tr>
                                                <td>
                                                    <i class="{{ \App\Helpers\Helper::filetype_icon($file->filename) }} icon-med"
                                                ...
                                                <td>
                                                    @if ( \App\Helpers\Helper::checkUploadIsImage($file->get_src('assets')))
                                                        <a href="{{ route('show/assetfile', ['assetId' => $asset->id, 'fileId' =>$file->id]) }}"
                                                           ...
                                                           data-footer="{{ \App\Helpers\Helper::getFormattedDateObject($asset->last_checkout, 'datetime', false) }}">
